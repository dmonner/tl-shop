...
public class LTLControlRulesTest extends TestCase
{
	...
	public void testConjoin()
	{
		...
		b = p1;
		assertTrue(ControlRules.conjoin(a, b).toString().equals(
		  LTLFalse.getInstance().toString()));

		// second expression false
		assertTrue(ControlRules.conjoin(b, a).toString().equals(
		  LTLFalse.getInstance().toString()));

		// first expression true
		a = LTLTrue.getInstance();
		assertTrue(ControlRules.conjoin(a, b).toString().equals(p1.toString()));

		// second expression true
		assertTrue(ControlRules.conjoin(b, a).toString().equals(p1.toString()));
	...
	public void testDisjoin()
	{
		...
		a = LTLTrue.getInstance();
		b = p1;
		assertTrue(ControlRules.disjoin(a, b).toString().equals(
		  LTLTrue.getInstance().toString()));

		// second expression true
		assertTrue(ControlRules.disjoin(b, a).toString().equals(
		  LTLTrue.getInstance().toString()));

		// first expression false
		a = LTLFalse.getInstance();
		assertTrue(ControlRules.disjoin(a, b).toString().equals(p1.toString()));

		// second expression false
		assertTrue(ControlRules.disjoin(b, a).toString().equals(p1.toString()));
	...
	public void testSimplify()
	{
		...
		assertTrue(ControlRules.simplify(e).toString().equals(
		...
		assertTrue(ControlRules.simplify(e) instanceof LTLTrue);
		...
		assertTrue(ControlRules.simplify(e) instanceof LTLFalse);
		...
		s = e.toString();
		assertTrue(ControlRules.simplify(e).toString().equals(s));
		...
		assertTrue(ControlRules.simplify(e).toString().equals(p6x.toString()));
		...
		e = p1;
		assertTrue(ControlRules.simplify(e).toString().equals(p1.toString()));
	...
	public void testProgressConjunction()
	{
		...
		assertTrue(ControlRules.progress(s, e).toString().equals(
	...
	public void testProgressUntil()
	{
		...
		assertTrue(ControlRules.progress(s, e).toString()
		  .equals(
