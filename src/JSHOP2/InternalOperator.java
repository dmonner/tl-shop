...
public class InternalOperator extends InternalElement
{
	 ...
	 * <code>DelAddElement</code>. Note that a <code>Vector</code>, rather
	 * than an array, is used, since at compile time we do not know how many
	 ...
	 *          <code>Vector</code> is of type <code>Integer</code>. If it is
	 *          not <code>null</code>, it means that the delete list of this
	 *          operator is a variable, and the value of the <code>Integer</code>
	 *          shows that variable's index. Otherwise, the rest of the
	 ...
	 *          <code>Vector</code> is of type <code>Integer</code>. If it is
	 *          not <code>null</code>, it means that the add list of this
	 *          operator is a variable, and the value of the <code>Integer</code>
	 *          shows that variable's index. Otherwise, the rest of the
	 *          <code>Vector</code> is of type <code>DelAddElement</code>,
	...
	public String toCode()
	{
		...
		s += ", " + cost.toCode() + ", " + singleRule.toCode() + ");" + endl + endl;
