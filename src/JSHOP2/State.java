...
public class State
{
  ...
  */
   ...
   *
   *  @param delAdd
   *          a 4-member array of type <code>Vector</code>. These four members
   *          are the deleted atoms, the added atoms, the deleted protections
   *          and the added protections respectively.
  */
