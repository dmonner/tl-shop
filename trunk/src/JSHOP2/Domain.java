...
/**
 * Each domain at run time is represented as a class derived from this abstract
 * class.
 * 
...
{
	/**
	 * The axioms in this domain. The array is indexed by first the predicate each
	 * axiom can prove, and second the order the axioms that prove the same
	 * predicate appear in the domain description.
	 */
	protected Axiom[][] axioms;

	/**
	 * The <code>String</code> names of compound tasks that appear in the domain
	 * description. These <code>String</code>s are only used to print the task
	 * lists, since the compound tasks are mapped to integers at compile time. The
	 * same integers are used to index this array.
	 */
	protected String[] compoundTasks;

	/**
	 * The <code>String</code> names of constant symbols that appear in the
	 * domain description. These <code>String</code>s are only used to print
	 * the constant symbols, since the constant symbols are mapped to integers at
	 * compile time. The same integers are used to index this array.
	 */
	protected String[] constants;

	/**
	 * The conjunction of all control rules for this domain.
	 */
	protected LTLExpression controlRules;

	/**
	 * The methods in this domain. The array is indexed by first the compound task
	 * each method can decompose, and second the order the methods that decompose
	 * the same compound task appear in the domain description.
	 */
	 ...
	 * domain description. These <code>String</code>s are only used to print
	 * the task lists, since the primitive tasks are mapped to integers at compile
	 ...
	 * 
	 * @return the axioms in this domain.
	 */
	 ...
	 * @return the <code>String</code> representation of the constant symbol.
	 */
	...
	/**
	 * This function returns the conjunction of all control rules of this domain.
	 * 
	 * @return the control rules of this domain.
	 */
	 ...
	 * of all the primitive tasks in the domain description. This list is used to
	 * print the plans after they are found.
	 * 
	 * @return the array of <code>String</code> representations of the primitive
	 *         tasks in the domain.
	 */
