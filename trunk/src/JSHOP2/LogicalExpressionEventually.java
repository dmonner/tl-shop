 ...
 * @version 1.0.3
 */
public class LogicalExpressionEventually extends LogicalExpression
{
	/**
	 ...
	 *          the logical expression that must eventually hold.
	 */
	public LogicalExpressionEventually(LogicalExpression leIn)
	{
		le = leIn;
		hasTemporalOps = true;
	}
	 ...
	 * eventually hold which this object represents.
	 */
